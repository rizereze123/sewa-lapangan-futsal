...
// Query SQL untuk mengambil data pelanggan berdasarkan pelanggan_id
...
<body>
    <nav class="navbar navbar-light">
        <div class="container d-block">
            <a href="index.php"><i class="bi bi-chevron-double-left"></i></a>
            <a class="navbar-brand" href="index.php">
                <img src="admin/assets/images/logo/logo.png">
            </a>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-3">
                            <div class="list-group" role="tablist">
                                <div class="card-heading text-center mt-3">
                                    ...
                                    <div class="user-name text-center me-3 mb-4">
                                        ...
                                        <h6 class="mb-0 text-xl text-gray-900 mt-1">
                                            <?php echo $_SESSION['pelanggan_nama_lengkap'] ?>
                                        </h6>
                                ...
                                <a class="list-group-item list-group-item-action" href="proses/pelanggan/logout_pelanggan.php"><i class="icon-mid bi bi-box-arrow-left me-2"></i> Logout</a>
                            </div>
                        </div>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                                <div class="tab-content text-justify" id="nav-tabContent">
                                    <div class="tab-pane show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                                        <div class="card-body">
                                            <form class="form form-vertical" action="proses/pelanggan/proses_edit_profile_pelanggan.php" method="post">
                                                <div class="row">
