...
// Query SQL untuk mengambil total akun admin (karyawan)
...
if ($resultAdmin) {
    ...
    $totalAdmin = 0; // Atur nilai default jika terjadi kesalahan
}

// Query SQL untuk mengambil total akun member pelanggan
...
if ($resultPelanggan) {
    ...
    $totalPelanggan = $rowPelanggan['total_pelanggan'];
} else {
    $totalPelanggan = 0; // Atur nilai default jika terjadi kesalahan
}
...
<head>
    ...
    <title>GSG Rizki | Dashboard Admin</title>
...
<body>
        ...
        <div id="main" class='layout-navbar'>
            ...
            <div id="main-content">
                ...
                <section class="section">
                    <h5>Pie Chart Data Akun Website</h5>
                    <div id="radial-gradient-chart"></div>
                    <br>
                    <br>
            </div>
            </section>
    ...
    <script>
        // Data total akun admin dan pelanggan
        var totalAdmin = <?php echo $totalAdmin; ?>;
        var totalPelanggan = <?php echo $totalPelanggan; ?>;
        ...
        var options = {
            ...
            labels: ['Admin (Karyawan)', 'Pelanggan Member Aktif'],
            series: [totalAdmin, totalPelanggan],
            colors: ['#FFB64D', '#5A8DEE'],
        };

        var chart = new ApexCharts(document.querySelector("#radial-gradient-chart"), options);
        chart.render();
    </script>
    <script>
