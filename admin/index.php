...
<head>
    ...
    <title>GSG Rizki | Login Admin</title>
...
<body>
    ...
    ?>
    <form action="../proses/admin/proses_login_admin.php" method="post" id="loginForm">
        <label for="judul" class="judullabel">Login Karyawan</label>
        <label for="judul2" class="judullabel2">GSG Rizki Futsal</label>
