...
<head>
    ...
    <title>GSG Rizki | Manajemen Akun Karyawan</title>
                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Manajemen Akun Karyawan</h3>
                                <p class="text-subtitle text-muted">Menambah Akun Karyawan Barumu Disini!</p>
                            </div>
                        </div>
                    </div>
                </div>
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <a href="#" class="btn icon icon-left btn-primary" data-bs-toggle="modal" data-bs-target="#tambah-akun-karyawan">Tambah Akun Karyawan</a>
                            <!--primary theme Modal -->
                            <div class="modal fade text-left" id="tambah-akun-karyawan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel160" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary">
                                            <h5 class="modal-title white" id="myModalLabel160">Tambah Akun Karyawan
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="card">
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form class="form form-vertical" action="../proses/admin/proses_tambah_akun_admin.php" method="post">
                                                            <div class="form-body">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="exampleFormControlTextarea1" class="form-label">Email</label>
                                                                            <input type="email" id="email" name="email" class="form-control" placeholder="Masukkan Email (example@gmail.com)" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" id="telepon" name="telepon" class="form-control" placeholder="Masukkan No Telepon (08XXXXXXXX)" required>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                ...
                                <tbody>
                                    <?php while ($row = mysqli_fetch_assoc($result)) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="buttons">
                                                    <a href="#" class="btn icon btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $row['admin_id']; ?>"><i class="bi bi-x"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <!-- Delete Modal -->
                                        <div class="modal fade text-left" id="deleteModal<?php echo $row['admin_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1602" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header bg-danger">
                                                        <h5 class="modal-title white" id="myModalLabel1602">Konfirmasi Hapus Akun Karyawan
                                                        </h5>
                                                        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                                                            <i data-feather="x"></i>
                                                        </button>
                                                    ...
                                                    <div class="modal-body">
                                                        Apakah Anda yakin ingin menghapus data akun karyawan ini?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                        <form action="../proses/admin/proses_delete_akun_admin.php" method="post">
