...
<head>
    ...
    <title>GSG Rizki Futsal | Harga dan Metode Pembayaran</title>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <p>Pengguna Dapat melakukan Proses Pembayaran Dengan cara offline atapun melakukan Transfer kepada No Rekening Admin, GSG Rizki Futsal</p>
                                </div>
                                <div class="col-md-4">
                                    <div class="card card-dark bg-secondary-gradient">
                                        <div class="card-body bubble-shadow">
                                            <img src="" height="12.5" alt="BANK BRI">
                                            <h2 class="py-4 mb-0">1234 6789 0934 92</h2>
                                            <div class="row">
                                                <div class="col-8 pr-0">
                                                    <h3 class="fw-bold mb-1">GSG Rizki Futsal</h3>
                                ...
                                <div class="col-md-4">
                                    <div class="card card-dark bg-secondary-gradient">
                                        <div class="card-body skew-shadow">
                                            <img src="" height="12.5" alt="BANK MANDIRI">
                                            <h2 class="py-4 mb-0">4634 4369 0688 90</h2>
                                            <div class="row">
                                                <div class="col-8 pr-0">
                                                    <h3 class="fw-bold mb-1">GSG Rizki Futsal</h3>
                                                    <div class="text-small text-uppercase fw-bold op-8">Card Holder</div>
                            ...
                            <div class="row justify-content-center align-items-center mb-1">
                                    ...
                                    <div class="card card-pricing">
                                        ...
                                        <div class="card-body">
                                            <ul class="specification-list">
                                                <li>
                                                    <span class="name-specification">Tipe Lapangan</span>
                                                    <span class="status-specification">Semen Floor</span>
                                                </li>
                                                <li>
                                                    <span class="name-specification">Bola</span>
                                                    <span class="status-specification">2</span>
                                                </li>
                                                <li>
                                                    <span class="name-specification">Luas</span>
                                                    <span class="status-specification">26x15 meter</span>
                                                </li>
                                                <li>
                                                    <span class="name-specification">Perawatan</span>
                                        ...
                                        <!-- <div class="card-footer">
                                            <button class="btn btn-primary btn-block"><b><a href="">Booking Now</a></b></button>
                                        </div> -->
                                    </div>
                                </div>
                                    ...
                                    <div class="card card-pricing card-pricing-focus card-secondary">
                                        ...
                                        <div class="card-body">
                                            <ul class="specification-list">
                                                <li>
                                                    <span class="name-specification">Tipe Lapangan</span>
                                                    <span class="status-specification">Rumput Sintetis</span>
                                                </li>
                                                <li>
                                                    <span class="name-specification">Bola</span>
                                                    <span class="status-specification">2</span>
                                                ...
                                                <li>
                                                    <span class="name-specification">Luas</span>
                                                    <span class="status-specification">24x14 meter</span>
                                                </li>
                                                <li>
                                                    <span class="name-specification">Perawatan</span>
                                                    <span class="status-specification">Yes</span>
                                        ...
                                        <div class="card-footer">
                                            <button class="btn btn-light btn-block"><a href="pemesanan_pelanggan.php"><b>Booking Now</b></a></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3 pr-md-0">
                                    <div class="card card-pricing">
                                        <div class="card-header">
                                            <h4 class="card-title">Lapangan C</h4>
                                            <div class="card-price">
                                                <span class="price">Rp80.000</span>
                                                <span class="text">/jam</span>
                                            </div>
