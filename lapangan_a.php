...
// Query SQL untuk mengambil data dari tabel lapangan_futsal
$query = "SELECT * FROM lapangan_futsal WHERE nama_lapangan = 'Lapangan A'";
...
<head>
    ...
    <title>GSG Rizki Futsal | Lapangan A</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="font-weight-bold">Lapangan A</h2>
                                    <div class="card-category">Detail dan Informasi Terkait Lapangan Ini</div>
                                </div>
                                <div class="card-body">
                                    <div id="owl-demo3" class="owl-carousel owl-theme owl-img-responsive">
                                        <div class="item"><img class="img-fluid" src="assets/img/lapangana1.jpeg" alt="1"></div>
                                        <div class="item"><img class="img-fluid" src="assets/img/lapangana2.jpeg" alt="2"></div>
                                        <div class="item"><img class="img-fluid" src="assets/img/lapangana3.jpeg" alt="3"></div>
                                        <div class="item"><img class="img-fluid" src="assets/img/lapangana4.jpeg" alt="4"></div>

                                        <div class="item"><img class="img-fluid" src="assets/img/lapangana6.jpg" alt="6"></div>
                                        <div class="item"><img class="img-fluid" src="assets/img/lapangana7.jpg" alt="7"></div>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        $harga_perjam = "Rp" . number_format($row['harga_per_jam'], 0, ',', '.'); // Mengubah harga_perjam ke format Rupiah
                                        echo "<p><strong>Tipe Lapangan:</strong> " . $row['tipe_lapangan'] . "</p>";
                                        echo "<p><strong>Harga per Jam:</strong> " . $harga_perjam  . "</p>";
                                        echo "<p class='justify-text'>" . $row['deskripsi'] . "</p>";
                                    }
                                    ?>
                                </div>
                            </div>
