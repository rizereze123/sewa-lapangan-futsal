...
<head>
    ...
    <title>GSG Rizki Futsal | Help</title>
            ...
            <div class="container">
                <div class="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <!-- TimeLine -->
                            <h4 class="page-title">Tata Cara Pemesanan dan Pembayaran Reservasi Booking Lapangan Futsal</h4>
                            <div class="row">
                                <div class="col-md-12">

                                    <ul class="timeline">
                                        <li>
                                            <div class="timeline-badge"><i class="flaticon-calendar"></i></div>
                                            <div class="timeline-panel">
                                                <div class="timeline-heading">
                                                    <h4 class="timeline-title">Melakukan Pemesanan</h4>
                                                    <p><small class="text-muted"><i class="flaticon-user-1"></i> Pengguna Perlu Melakukan Login / SignUp Terlebih Dahulu</small></p>
                                                </div>
                                                <div class="timeline-body">
                                                    <p>Pengguna Telah Melihat Jadwal yang Tersedia di Halaman Dashboard dan Lakukanlah Pemesanan Sesuai dengan Jadwal / Lapangan yang Diinginkan. Jika Anda Memesan Lapangan yang sudah
                                                        dipesan oleh pengguna lainnya, maka sistem akan menolak pemesanan anda.
                                                    </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="timeline-inverted">
                                            ...
                                            <div class="timeline-panel">
                                                <div class="timeline-heading">
                                                    <h4 class="timeline-title">Diarahkan ke Pembayaran</h4>
                                                </div>
                                                <div class="timeline-body">
                                                    <p>Setelah Melakukan Pemesanan, maka Pengguna akan Diarahkan ke Pembayaran. Tertera terdapat Nota Pembayaran seperti
                                                        Nominal, No Rekening Tujuan, Syarat, dan Ketentuan </p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div class="timeline-panel">
                                                <div class="timeline-heading">
                                                    <h4 class="timeline-title">Pembatalan Pemesanan</h4>
                                                </div>
                                                <div class="timeline-body">
                                                    <p>Jika Dirasa Terdapat Kesalahan saat Pemesanan, Pengguna dapat Melakukan Pembatalan Pemesanan dengan Syarat Pengguna tersebut Belum Melakukan Proses Upload Bukti Pembayaran</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="timeline-inverted">
                                            <div class="timeline-panel">
                                                <div class="timeline-heading">
                                                    <h4 class="timeline-title">Upload Bukti Pembayaran</h4>
                                                </div>
                                                <div class="timeline-body">
                                                    <p>Untuk Pembayaran, Pengguna perlu Melakukan Proses Upload Bukti Pembayaran Agar</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="timeline-badge info"><i class="flaticon-credit-card-1"></i></div>
                                            <div class="timeline-panel">
                                                <div class="timeline-heading">
                                                    <h4 class="timeline-title">Verifikasi Pembayaran Admin</h4>
                                                </div>
                                                <div class="timeline-body">
                                                    <p>Admin Akan Memeriksa Bukti Pembayaran Anda Secara Berkala. Sebagai Pengguna, Anda dapat mengecek Verivikasi Pembayaran Admin secara berkala di Halaman Pemesanan </p>
                                                    <hr>
                                                    <div class="btn-group dropdown">
                                                        <p>Jika Pengguna Tidak Melakukan Pembayaran Selama 30 Menit, Maka Proses Pemesanan dan Pembayaran Tersebut Akan Hangus</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="timeline-inverted">
                                            <div class="timeline-badge success"><i class="flaticon-list"></i></div>
                                            <div class="timeline-panel">
                                                <div class="timeline-heading">
                                                    <h4 class="timeline-title">Selesai</h4>
                                                </div>
                                                <div class="timeline-body">
                                                    <p>Jika Pembayaran Anda Disetujui Oleh Admin, maka Proses Pemesanan dan Pembayaran Anda Telah Berhasil dan Anda Dapat Datang Langsung Ke Tempat Lapangan Futsal Sesuai Dengan Jadwal Pemesanan</p>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
