...
$query = "SELECT * FROM lapangan_futsal WHERE nama_lapangan = 'Lapangan B'";
...
<head>
    ...
    <title>GSG Rizki Futsal | Lapangan B</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h2 class="font-weight-bold">Lapangan B</h2>
                                ...
                                <div class="card-body">
                                    <div id="owl-demo3" class="owl-carousel owl-theme owl-img-responsive">
                                        <div class="item"><img class="img-fluid" src="assets/img/lapanganb1.jpeg" alt="1"></div>
                                        <div class="item"><img class="img-fluid" src="assets/img/lapanganb2.jpg" alt="2"></div>
