...
<head>
    ...
    <title>GSG Rizki | Login Pelanggan</title>
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:400,600,700" rel="stylesheet">
    <link rel="stylesheet" href="assets_extentions/css/login.css">
...
<body>
    ...
    ?>
    <form action="proses/pelanggan/proses_login_pelanggan.php" method="post" id="loginForm">
        <label for="judul" class="judullabel">Login Pelanggan</label>
        <label for="judul2" class="judullabel2">Member GSG Rizki Futsal</label>
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input type="text" id="email" name="email" class="email" maxlength="256" autocomplete="off" required />
        ...
        <div class="inputGroup">
            <center>
                <label for="email"><a href="signup_pelanggan.php">Belum Punya Akun? SignUp</a></label>
            </center>
        </div>
    </form>
    ...
    <script src="assets_extentions/js/login.js"></script>
    <script>
